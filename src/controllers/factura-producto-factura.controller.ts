...
export class FacturaProductoFacturaController {
  ...
  async find(
    ...
    return this.facturaRepository.productoFacturas(id).find(filter);
  }
  ...
  async create(
    ...
    return this.facturaRepository.productoFacturas(id).create(productoFactura);
  }
  ...
  async patch(
    ...
    return this.facturaRepository.productoFacturas(id).patch(productoFactura, where);
  }
  ...
  async delete(
    ...
    return this.facturaRepository.productoFacturas(id).delete(where);
  }
}
